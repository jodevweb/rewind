...
const s: Step[] = [
  ...
  },
  {
    ...
    privacyLevel: 'sensitive',
    meta: { previousTitle: 'acme — #product — Slack' },
    note: 'The anchor "Checkout Redesign" first appears in a window title.',
  },

  {
    ...
    note: 'ACM-4218 — a structured identifier in a native app window title. The strongest anchor available at Level 1.',
  },
  {
    t: '09:21:10',
    ctx: 'homestaging',
    app: 'com.linear',
    type: 'system.window.title_changed',
    title: 'ACM-4218 Checkout Redesign generation flow — In Progress — Linear',
    meta: { previousTitle: 'ACM-4218 Checkout Redesign generation flow — Linear' },
  },

  {
    ...
    type: 'system.window.focus',
    title: 'Checkout Redesign V3 — Figma',
    endT: '09:30:20',
    important: true,
  ...
  },
  {
    ...
    meta: { previousTitle: 'Checkout Redesign V3 — Figma' },
  },

  {
    ...
    app: 'com.apple.Notes',
    type: 'system.window.focus',
    title: 'Checkout Redesign thoughts — Notes',
    endT: '09:38:10',
    privacyLevel: 'sensitive',
  ...
  },
  {
    ...
    meta: {
      source: 'cockpit',
      mission: 'Checkout Redesign generation flow',
      missionId: 'msn_8841',
  ...
  },
  {
    ...
    meta: {
      ...
      missionId: 'msn_8841',
      agent: 'claude-code',
      worktree: '/Users/dev/dev/acme-wt/ACM-4218',
    },
  },
...

  {
    ...
    app: 'com.acme.cockpit',
    type: 'system.window.focus',
    title: 'Checkout Redesign — run 3 — Cockpit',
    endT: '10:26:00',
    meta: { bundleId: 'com.acme.cockpit' },
  },
  {
...

  {
    ...
    app: 'com.apple.mail',
    type: 'system.window.focus',
    title: 'Re: Checkout Redesign V3 — retours client — Mail',
    endT: '10:31:00',
    privacyLevel: 'sensitive',
    important: true,
  ...
  },
  {
    ...
    important: true,
    meta: {
      text: 'Claude a fini la première implémentation de la génération. Reste à relire le masque avant de merger ACM-4218.',
    },
  },
];
...
export const gs07 = buildSession({
  ...
  tests:
    'The fixture that proves REWIND is work-context-first rather than developer-first. Almost every event is generic Level 1 window observation; there is no IDE, and the repository appears only after an hour. Grouping must come from anchors — "Checkout Redesign", ACM-4218, the project name — and from temporal and semantic proximity. An engine that leans on repositoryId, workspace or file overlap recovers almost nothing here.',
  day: '2026-04-14',
  tzOffsetMinutes: 120,
  defaultRepo: null,
  contexts: {
    homestaging: {
      ...
      outcome: 'unresolved',
      expectedNextStep: "Review Claude's implementation of the mask before merging ACM-4218",
      note: 'Nine applications, one context. Expected Today entry: "Checkout Redesign V3 · 1h30 · Slack → Linear → Figma → Cockpit → Claude".',
    },
  },
  steps: s,
});
