...
const s: Step[] = [
  ...
  },
  {
    ...
    type: 'system.window.focus',
    title: 'acme — #project-alpha — Slack',
    endT: '14:12:40',
  ...
  // ── Interruption 1: Slack, same application as the real work, different subject. ─────────────
  {
    ...
    app: 'com.tinyspeck.slackmacgap',
    type: 'system.window.focus',
    title: 'acme — #random — déjeuner vendredi — Slack',
    endT: '14:29:50',
    privacyLevel: 'sensitive',
    meta: { bundleId: 'com.tinyspeck.slackmacgap' },
  ...
  },
  {
    ...
    meta: {
      agent: 'claude-code',
      model: 'claude-opus-5',
      projectPath: '/Users/dev/dev/project-alpha',
    },
  },
  {
    t: '14:56:20',
  ...
  // ── Interruption 3: Slack again, unrelated, slightly longer. ─────────────────────────────────
  {
    ...
    app: 'com.tinyspeck.slackmacgap',
    type: 'system.window.focus',
    title: 'acme — #général — annonce RH — Slack',
    endT: '15:05:40',
    privacyLevel: 'sensitive',
    meta: { bundleId: 'com.tinyspeck.slackmacgap' },
  },
  ...
  },
  {
    ...
    meta: {
      ...
      cwd: '/Users/dev/dev/project-alpha',
      exitCode: 0,
      durationMs: 2300,
      shell: 'zsh',
    },
